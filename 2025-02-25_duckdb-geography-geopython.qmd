...
There are [more advanced ways to use DuckDB to do this](https://dewey.dunnington.ca/post/2024/partitioning-strategies-for-bigger-than-memory-spatial-data/#using-s2-cells-fixed-cell-level) (e.g., adapting the cell level to the number of points in each cell to better balance them)
